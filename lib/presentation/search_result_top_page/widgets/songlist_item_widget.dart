  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Row(
        ...
        children: [
          CustomImageView(
            imagePath: songlistItemModelObj?.handsome,
            height: 80.adaptSize,
            width: 80.adaptSize,
          ...
          Padding(
            ...
            child: CustomIconButton(
              ...
              child: CustomImageView(
                imagePath: songlistItemModelObj?.overflowMenu,
              ),
            ),
          ),
          CustomImageView(
            imagePath: songlistItemModelObj?.handsome1,
            height: 20.adaptSize,
            width: 20.adaptSize,
