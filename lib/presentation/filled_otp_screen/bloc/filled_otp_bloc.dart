import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:dhiwise_flutter_music_app/presentation/filled_otp_screen/models/filled_otp_model.dart';import 'package:sms_autofill/sms_autofill.dart';part 'filled_otp_event.dart';part 'filled_otp_state.dart';/// A bloc that manages the state of a FilledOtp according to the event that is dispatched to it.
