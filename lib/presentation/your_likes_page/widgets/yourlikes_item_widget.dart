...
class YourlikesItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        CustomImageView(
          imagePath: yourlikesItemModelObj?.image,
        ...
        Column(
          ...
          children: [
            SizedBox(
              width: 235.h,
              child: Text(
                yourlikesItemModelObj.podcastTitle!,
                maxLines: 2,
            ...
            Row(
              children: [
                Text(
                  yourlikesItemModelObj.author!,
                  style: theme.textTheme.labelLarge,
                ),
                Padding(
                  padding: EdgeInsets.only(left: 12.h),
                  child: Text(
                    yourlikesItemModelObj.text!,
                    style: theme.textTheme.labelLarge,
                  ),
                ),
                Padding(
            ...
            SizedBox(
              ...
              child: Row(
                children: [
                  CustomImageView(
                    imagePath: yourlikesItemModelObj?.image1,
                    height: 20.adaptSize,
                    width: 20.adaptSize,
