...
class DownloadedlistItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        CustomImageView(
          imagePath: downloadedlistItemModelObj?.image,
        ...
        Column(
          ...
          children: [
            SizedBox(
              width: 235.h,
              child: Text(
                downloadedlistItemModelObj.podcastTitle!,
                maxLines: 2,
            ...
            Row(
              children: [
                Text(
                  downloadedlistItemModelObj.author!,
                  style: theme.textTheme.labelLarge,
                ),
                Padding(
                  padding: EdgeInsets.only(left: 12.h),
                  child: Text(
                    downloadedlistItemModelObj.text!,
                    style: theme.textTheme.labelLarge,
                  ),
                ),
                Padding(
                  padding: EdgeInsets.only(left: 12.h),
                  child: Text(
                    downloadedlistItemModelObj.time!,
                    style: theme.textTheme.labelLarge,
                  ),
                ),
              ],
            ...
            SizedBox(
              ...
              child: Row(
                children: [
                  CustomImageView(
                    imagePath: downloadedlistItemModelObj?.image1,
                    height: 20.adaptSize,
                    width: 20.adaptSize,
