import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:dhiwise_flutter_music_app/presentation/security_screen/models/security_model.dart';part 'security_event.dart';part 'security_state.dart';/// A bloc that manages the state of a Security according to the event that is dispatched to it.
...
_onInitialize(SecurityInitialEvent event, Emitter<SecurityState> emit, ) async  { emit(state.copyWith(passwordController: TextEditingController(), isSelectedSwitch: false, isSelectedSwitch1: false, isSelectedSwitch2: false)); } 
 }
